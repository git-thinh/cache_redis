...
{
    public interface IRedisDataAccessProvider {
        int SendCommand(RedisCommand command, params string[] args);

        int SendCommand(RedisCommand command, byte[] datas, params string[] args);

        int SendCommand(RedisCommand command, IDictionary<string, byte[]> datas, params string[] args);

        int SendCommand(RedisCommand command, IDictionary<string, string> datas, params string[] args);

        void WaitComplete(int commandid = 0);

        int ReadInt(int commandid = 0);

        byte[] ReadData(int commandid = 0);

        byte[][] ReadMulti(int commandid = 0);

        string[] ReadMultiString(int commandid = 0);

        string ReadString(int commandid = 0);
    ...
    public class RedisDataAccessProvider : DataAccessProvider, IRedisDataAccessProvider, IDisposable
    {
        ...
        public RedisDataAccessProvider() : base()
        {
