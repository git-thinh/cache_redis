...
namespace ckv_site
{
    public class clsApi
    {
        ...
        static string[] m___get_ascii(string cache_name)
        {
            int index = -1;
            if (string.IsNullOrEmpty(cache_name)) return null;
        ...
        static string[] m___get_utf8(string cache_name)
        {
            int index = -1;
            if (string.IsNullOrEmpty(cache_name)) return null;
        ...
        public static string[] api_global_names() { return m_api_global.Keys.ToArray(); }
        public static string[] api_names() { return m_apis.Keys.ToArray(); }
        public static oApi[] api_list() { return m_apis.Values.ToArray(); }
        ...
        public static bool Exist(string name) { return m_apis.ContainsKey(name); }
